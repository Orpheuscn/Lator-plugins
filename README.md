...
This repository currently contains four maintained plugins. Each plugin lives under `src/` with its own `plugin.json`, runtime code, assets declaration, and plugin-specific documentation where applicable.

## Plugins

| Plugin | Version | Display name | License | What it does |
|---|---:|---|---|---|
| [bilingual-align](src/bilingual-align) | 0.1.1 | Bilingual Align | GPL-3.0 | Aligns translated text back to the source line layout with LaBSE embeddings and N:M alignment. |
...
- [Text Transliteration README](src/text-transliteration/README.md)
